...
author: "naviary"
heroImage: "../assets/naviary-system-02-tech-stacks/Bun.png"
draft: false
...
2. **Automatic API Documentation**
   ...
   <div className="flex flex-col items-center justify-center text-center">
     ![elysia-swagger](../assets/naviary-system-02-tech-stacks/elysia-swagger.png)
     <span className="text-sm text-[hsl(215,15%,50%)] italic">
...
In the [next post](naviary-system-03-design-models), I'll talk about domain model design.
