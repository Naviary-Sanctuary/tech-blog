...
import eggHatchedEvent from "../assets/naviary-system-04-domain-event/eggHatchedEvent.png";
import resolveWire from "../assets/naviary-system-04-domain-event/resolve-wire.png";
...
<div className="flex flex-col items-center justify-center text-center">
  <MdxImage src={eggHatchedEvent} alt="eggHatchedEvent" />
</div>
...
<div className="grid w-full grid-cols-1 md:grid-cols-2 gap-4 items-start mb-4">
...
<div className="flex flex-col items-center justify-center text-center">
  <MdxImage src={resolveWire} alt="resolve-wire" />
</div>
...
It is better to think of it as "to cleanly separate complex domain logic to make maintenance easier." I felt more familiar with this approach because it was used in an organization I previously worked for (a company with many talented developers).
