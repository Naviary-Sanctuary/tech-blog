...
I recently watched `Project Hail Mary`, and I enjoyed it a lot. In the story, there is a microorganism called **Astrophage** that absorbs energy from stars, stores it as mass, and then converts that mass back into energy to travel at incredible speeds.

I watched Project Hail Mary twice in theaters, once in IMAX. After coming home and thinking about it again, I realized, "My tech blog is built with Astro, but I still haven't written about that?"

So I decided to write this post: why I separated the tech blog, and why I chose Astro as its technology stack.
